#!/bin/bash
# tools/get-device-spec.sh — Auto-generate a disk.conf from a connected device.
#
# Usage:
...
# disk.conf suitable for use in config/disk.conf to stdout. The EFI partition
...
# ---------------------------------------------------------------------------
cat << CONF
# disk.conf — auto-generated by tools/get-device-spec.sh
#
